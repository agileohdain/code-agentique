# 02 — Comparatif : Claude Code, Codex, OpenCode, VS Code + Copilot

*État des lieux au 17/08/2026 — les prix et fonctionnalités bougent vite, à revérifier.*
...
| Entrée de gamme | 20 $/mois | 20 $/mois (Plus) | **Gratuit + API** | 10 $/mois |
| Usage intensif | Max 100–200 $/mois | Pro 100–200 $/mois | Quelques $/jour | Premium 39 $/mois |
...
**+** Léger et configurable par fichiers versionnables (`opencode.json`, agents, permissions, `AGENTS.md`).
